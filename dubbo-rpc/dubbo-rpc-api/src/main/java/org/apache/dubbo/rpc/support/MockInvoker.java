...
final public class MockInvoker<T> implements Invoker<T> {
    ...
    private Invoker<T> getInvoker(String mockService) {
        // 1 尝试从 MOCK_MAP 中获取对应的 Invoker 对象
        ...
        // 3 根据 serviceType 查找 mock 的实现对象
        T mockObject = (T) getMockObject(mockService, serviceType);

        // 4 通过 ProxyFactory 创建 mock 对应的 Invoker 对象
    ...
    public static Object getMockObject(String mockService, Class serviceType) {
        ...
        // 1 如果 mockService 为 true 或 default ，则在服务接口后添加 Mock 字符串，作为服务接口的 Mock 实现
    ...
    public static String normalizeMock(String mock) {
        ...
        // 1 等于 return ，则返回 return null
        if (RETURN_KEY.equalsIgnoreCase(mock)) {
            return RETURN_PREFIX + "null";
        }

        // 2 为 "true" "default" "fail" "force" 四种字符串，则直接返回 default
